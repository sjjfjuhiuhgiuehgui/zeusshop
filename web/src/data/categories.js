...
export const matchByKey = (key) => (p) => String(p?.category) === String(key)

// ⛳ 舊：keywords 模糊比對（保留相容，之後可移除）
export const matchByKeywords = (keywords) => (p) => {
...
export const CATEGORIES = [
  ...
  { key: 'home-decor', label: '家飾／裝設', Icon: Lamp, keywords: ['家飾','裝設','燈','檯燈','落地燈','窗簾','地毯','掛畫','擺件','置物架','收納','佈置'] },
  { key: 'fashion', label: '時尚服飾', Icon: Shirt, keywords: ['布疋','服飾','衣著','上衣','外套','褲','裙','鞋','帽','傘','內衣','配件','圍巾'] },
  { key: 'edu-music-toys', label: '文教／樂器／育樂', Icon: BookOpen, keywords: ['文教','文具','書','教具','教材','樂器','吉他','烏克麗麗','鋼琴','玩具','積木','桌遊','育樂'] },
  { key: 'building-materials', label: '建材／DIY', Icon: Hammer, keywords: ['建材','木材','五金','螺絲','油漆','瓷磚','水泥','管件','水電','工具','砂紙','膠'] },
  { key: 'appliances', label: '家電', Icon: WashingMachine, keywords: ['家電','電器','洗衣機','冰箱','冷氣','吸塵器','除濕機','電鍋','微波爐','電風扇','烤箱','氣炸'] },
  { key: 'precision-instruments', label: '精密儀器', Icon: Microscope, keywords: ['精密','儀器','量測','卡尺','顯微鏡','光學','示波器','測距','天平','量規','感測'] },
